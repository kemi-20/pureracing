...
// News
@Serializable data class NewsItem(val id: Int, val title: String = "", val istop: Int = 0, val total_read: Int = 0,
    val type: Int = 0, val publish_time: Long = 0, val gp_id: String = "", val http_url: String = "",
...
@Serializable data class RaceGp(val race_time: String = "", val race_time_detail: String = "",
    val gp_id: String = "", val gp_name: String = "", val chp_name: String = "", val chp_logo: String = "",
...
@Serializable data class SessionResult(val rank: Int = 0, val driverid: String = "", val dr_name: String = "",
    val teamid: String = "", val team_logo: String = "", val gap: String = "")
...
@Serializable data class RankingOption(val chp_id: Int = 0, val id: Int = 0, val name: String = "", val custom_name: String = "")
